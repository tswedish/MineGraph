...
impl SearchStrategy for SimulatedAnnealing {
    ...
    fn search(&self, job: &SearchJob, observer: &dyn SearchObserver) -> SearchResult {
        ...
        let mut graph = job
            .init_graph
            .clone()
            .unwrap_or_else(|| extremal_strategies::init::random_graph(n, &mut rng));
        ...
        let mut known_cids: HashSet<extremal_types::GraphCid> = job.known_cids.clone();
...
mod tests {
    ...
    fn sa_finds_r33_n5() {
        ...
        let job = SearchJob {
            ...
            max_iters: 50_000,
            seed: 42,
            init_graph: Some(extremal_strategies::init::paley_graph(5)),
    ...
    fn sa_finds_r44_n17() {
        ...
        let job = SearchJob {
            ...
            max_iters: 500_000,
            seed: 42,
            init_graph: Some(extremal_strategies::init::paley_graph(17)),
