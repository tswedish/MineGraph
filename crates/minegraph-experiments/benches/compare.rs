...
//! use the CLI harness instead (`cargo run -p minegraph-experiments -- compare`).

use criterion::{Criterion, criterion_group, criterion_main};
use minegraph_experiments::all_strategies;
use minegraph_strategies::init::paley_graph;
use minegraph_worker_api::{CollectingObserver, SearchJob};
