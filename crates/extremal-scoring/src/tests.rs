...
mod scoring_pipeline {
    ...
    fn canonical_cid_dedup_isomorphic() {
        ...
        let cid1 = extremal_graph::compute_cid(&c1);
        let cid2 = extremal_graph::compute_cid(&c2);
        assert_eq!(cid1, cid2);
    }
    ...
    fn canonical_cid_distinct_non_isomorphic() {
        ...
        let cid_c = extremal_graph::compute_cid(&cc);
        let cid_p = extremal_graph::compute_cid(&cp);
