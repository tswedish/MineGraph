...
# MineGraph v1 Description

MineGraph is a combinatorial graph search game. The goal of the game is to find the highest scoring graphs and post them on public leaderboards.
